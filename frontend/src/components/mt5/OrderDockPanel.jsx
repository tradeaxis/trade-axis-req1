...
export default function OrderDockPanel({ symbol, bid, ask, offQuotes = false, leverage = 5, freeMargin = 0, onBuy, onSell }) {
    ...
    <div className="h-full w-full flex flex-col">
      ...
      <div className="p-3 text-xs border-b mt5-border">
        <div className="flex items-center gap-2">
          ...
          {offQuotes && <span style={{ color: '#ff9800', fontSize: '11px', fontWeight: 700 }}>Off Quotes</span>}
        </div>
      ...
      <div className="p-3 mt-auto">
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            style={{
              background: 'var(--mt5-red)',
              color: '#fff',
              opacity: offQuotes ? 0.6 : 1,
              cursor: offQuotes ? 'not-allowed' : 'pointer',
            }}
          >
            SELL
          </button>
